...
final class Sender: NSObject {
	...
	init(with camera: AVCaptureDevice) throws {
		...
		target.videoSettings = [
			kCVPixelBufferPixelFormatTypeKey as String: kCVPixelFormatType_422YpCbCr8 // UYVY, default in general case
...
//			kCVPixelBufferPixelFormatTypeKey as String: kCVPixelFormatType_32RGBA // RGBA or RGBX, it might not work with FaceTime HD camera on Apple Silicon
		]
